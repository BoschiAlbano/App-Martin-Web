                            ...
                            <Link className=" flex flex-col justify-center items-center text-center rounded-xl bg-white py-6 sm:py-8 " href="/articulos/0/Todo">
                                ...
                                <div className=" sm:px-2">
                                    ...
                                    <p className="mt-2 text-sm text-gray-900">
                                        tu destino de compras mayoristas en línea
                                    </p>
                                    <p className="mt-2 text-sm text-gray-500 hidden lg:block">Somos tu socio confiable para abastecer tu negocio con artículos diversos, desde medicamentos y productos desechables hasta cigarrillos y golosinas deliciosas.</p>
