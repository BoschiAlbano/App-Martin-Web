...
const datos = [
    ...
    {
        ruta: "/articulos/0/Todo",
        nombre: "Articulos",
        icono: IoFastFoodOutline,
        subMenu: [],
    },
    ...
    return (
        <>
            <Head>
                ...
                <meta
                    name="description"
                    content="Distrinova, Tu destino de compras mayoristas en linea."
                />
            ...
            {/* Barra de abajo */}
            <nav
                className={`fixed ${background} z-[100] rounded-t-xl  h-12 w-full transition-all duration-500 ${
                    ocultar ? "bottom-[-100%] oculto" : "bottom-0"
                } sm:hidden`}
            >
                <div className="flex flex-row justify-between items-center mx-1">
                    {datos.map((_item, i) => {
                        return (
                            <Link key={i} href={_item.ruta}>
