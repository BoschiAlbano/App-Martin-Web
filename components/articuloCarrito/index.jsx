  ...
  const AumentarCantidad = (e) => {
    ...
    return (
        <div className="ArticuloCarro p-2 justify-items-center items-center hover:bg-slate-200">
          ...
          <img src={item.imagen} alt={item.descripcion} className="ArticuloCarro1" />
    
                <p className='ArticuloCarro2 text-2xl text-gray-600'>{item.descripcion}</p>
                <p className='ArticuloCarro22 text-2xl text-gray-600'>{`$${item.precio}`}</p>
          ...
          <label  className=" ArticuloCarro3 flex items-center gap-2">
            ...
            <input
              ...
              className="w-full border border-gray-200 pl-3 hover:border-[#5E69F1] rounded-md shadow-sm focus:outline-none"
            />
          </label>
