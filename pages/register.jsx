...
const Register = () => {
    ...
    const onSubmit = async (data) => {
        ...
        const response = await fetch(
            `${Publicas.NEXT_PUBLIC_HOST}/api/usuario`,
            {
                method: "POST",
                body: JSON.stringify({
                    image: "http://images7.memedroid.com/images/UPLOADED43/5385438d7a708.jpeg",
                    ...resto,
                }),
                headers: {
    ...
    return (
        <Layout title={"Register"}>
            <div className="flex flex-col items-center">
                <div>
                    <h1 className="font-semibold sm:mt-6 mt-0 text-[40px]">
                        Registrarse
                    </h1>
                </div>
                ...
                <div className="h-10 w-80">
                    <div className="flex flex-col items-center w-80 overflow-hidden pt-0 max-h-[25px] mt-1 relative sm:absolute  ">
                        ...
                        {errors.Cpassword?.type === "validate" && (
                            <p className=" text-red-900">
                                La Password no coinciden
                            </p>
                        )}
                        {errorNextAuth && (
                            <p className=" text-red-900">{errorNextAuth}</p>
                        )}
                    </div>
                </div>
            </div>
